...
return [
    'name' => 'Image Proxy pimg tw',
    'url' => 'imageproxy.pimg.tw',
    ...
    // Throttler config
    'throttler' => [
        'allowed_requests' => 1000, // 700 allowed requests
        'minutes' => 1, // In 3 minutes
        'prefix' => 'c', // Cache key prefix,
        'driver' => 'memcached' // Throttler driver; defaulting to redis
    ],
    // Throttler whitelist
    'throttler-whitelist' => [
        '1.2.3.4' => 0, // Local IP
